...
func set_color(value: Color):
	if not is_instance_valid(material):
		...
		$skin/normal.set_surface_override_material(0, material)
...
func skin() -> void :
	$skin/normal.visible = false
	$skin/happy.visible = false
	$skin/earphones.visible = false
	$skin/tousu.visible = false
	$skin/crown.visible = false
	if State.skin == 1:
		$skin/normal.visible = true
	elif State.skin == 2:
		$skin/normal.visible = true
		$skin/earphones.visible = true
	elif State.skin == 3:
		$skin/happy.visible = true
	elif State.skin == 4:
		pass
	elif State.skin == 5:
		$skin/normal.visible = true
		$skin/crown.visible = true
	elif State.skin == -1:
		$skin/tousu.visible = true
