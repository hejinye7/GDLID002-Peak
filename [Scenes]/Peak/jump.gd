...
var preview_enabled := true: set = _set_preview_enabled
var preview_steps := 20: set = _set_preview_steps
var preview_color := Color(1, 0.8, 0.2): set = _set_preview_color
var marker_size := 0.2: set = _set_marker_size
...
func _find_mainline_node() -> Node:
	...
	for n in root.get_children():
		if n is Node and n.get_script() and n.get_script().resource_path == "res://MainLine.gd":
			return n
	return null
